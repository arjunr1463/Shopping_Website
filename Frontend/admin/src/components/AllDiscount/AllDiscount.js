    ...
    <div className="flex flex-col gap-[20px] w-full h-full px-[10px] py-[10px] text-[14px]">
      ...
      <div className="flex flex-col gap-[15px] p-4 bg-white  shadow-lg">
        <div className="flex items-center gap-[10px] border-b-[1px]">
          ...
          <span className="font-poppins text-[22px]">All Discount</span>
        </div>
          ...
          <table className="w-full">
            <thead className="border-[1px] font-mont text-gray-600">
              <tr>
                ...
                <th className="border-[1px] px-[20px] lg:px-0">
                  <div className="w-[80px] lg:w-full  gap-[10px]">
                    <span className="">User type</span>
                    
                  </div>
                </th>
                <th className="border-[1px] px-[20px] lg:px-0">
                  <div className="flex justify-center items-center w-[120px] lg:w-full gap-[10px]">
                    <span>Discount type</span>
                  </div>
                </th>
                <th className="border-[1px] px-[30px] lg:px-0">Discount</th>
                <th className="border-[1px] px-[30px] lg:px-0">Amount</th>
                <th className="border-[1px] px-[30px] lg:px-0">Status</th>
            ...
            <tbody className="border-[1px] text-center font-poppins text-[15px] text-gray-500">
              {paginatedData.map((data, index) => (
                <tr key={index}>
                  ...
                  <td className="border-[1px] ">{data.usertype}</td>
                  <td className="border-[1px] ">{data.discounttype}</td>
                  <td className="border-[1px] ">{data.discount}</td>
                  <td className="border-[1px] ">{data.amount}</td>
            ...
            <thead className="border-[1px] text-gray-600 font-mont">
              <tr>
                ...
                <th className="border-[1px]">User type</th>
                <th className="border-[1px]">Discount type</th>
                <th className="border-[1px]">Discount</th>
