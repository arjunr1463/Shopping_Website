        ...
        <table className="w-full">
          <thead className="border-[1px] font-mont text-gray-600">
            <tr>
              ...
              <th className="border-[1px] ">
                <div className="flex px-[10px] w-[200px] items-center gap-[10px]">
                  <span>Full Name</span>
                  <i
              ...
              <th className="border-[1px] ">
                <div className="flex px-[10px] w-[180px] items-center gap-[10px]">
          ...
          <tbody className="border-[1px] text-center font-poppins text-[15px] text-gray-500">
            {paginatedData.map((data, index) => (
              <tr key={index}>
                ...
                <td className="border-[1px] ">
                  <div className="flex font-semibold w-[140px] font-mont gap-[10px]">
                    <button className="text-[#345fa7]">View Customer</button>
                  </div>
                </td>
                <td className="border-[1px] ">
                  <div className="flex gap-[10px] font-semibold font-mont">
                    <button className="text-[#345fa7]">
                      View Credit Order
                    </button>
                  </div>
                </td>
