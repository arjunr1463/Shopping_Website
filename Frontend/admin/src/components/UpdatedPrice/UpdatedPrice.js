    ...
    <div className="flex flex-col gap-[20px] w-full h-full px-[10px] py-[10px]">
      ...
      <div className="flex flex-col gap-[15px] p-4 bg-white  shadow-lg">
        <div className="flex items-center gap-[10px] border-b-[1px]">
          ...
          <span className="font-poppins text-[22px]">Updated Price</span>
        </div>
          ...
          <table className="w-full">
            <thead className="border-[1px] font-mont text-gray-600">
              <tr>
                ...
                <th className="border-[1px] px-[30px] lg:px-0">Quantity</th>
                <th className="border-[1px] px-[20px] lg:px-0">
                  <div className="flex justify-center items-center gap-[10px]">
            ...
            <thead className="border-[1px] text-gray-600 font-mont">
              <tr>
                ...
                <th className="border-[1px]">Product name</th>
                <th className="border-[1px]">Unit</th>
                <th className="border-[1px]">Quantity</th>
                <th className="border-[1px]">Original</th>
                <th className="border-[1px]">Sale price</th>
