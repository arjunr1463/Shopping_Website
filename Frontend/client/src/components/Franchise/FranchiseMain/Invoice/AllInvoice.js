  ...
  return (
    <div className="flex flex-col gap-[25px]">
      <div className="flex gap-[10px] items-center text-[#2ad5b1] bg-white shadow-lg px-[15px] py-[10px] text-[15px] font-poppins">
        ...
        <span className="text-[#3d8879]">Invoices</span>
        <i>
          <AiOutlineRight />
        </i>
        <span className="text-[#3d8879]">All Invoice</span>
      </div>
      <div className="mx-[10px] sm:mx-[20px] flex flex-col gap-[10px]">
        <h className="font-mont font-semibold text-[22px]">All Invoice</h>
            ...
            <table className="border-[1px] text-center font-poppins text-[15px] text-gray-500">
              ...
              <tbody>
                {paginatedData.map((data, index) => (
                  <tr key={index}>
                    ...
                    <td className="border-[1px]"><div className="w-[150px] xl:w-auto">{data.date}</div></td>
              ...
              <thead>
                <tr>
                  ...
                  <th className="border-[1px]">Invoice ID</th>
                  <th className="border-[1px]">Order ID</th>
